...
I miss u // I miss your sister!
you want to go to the movies? // your sister want to go to the movies?
...
const autocorrect = input => input.replace(/((?<!\w+)you+(?!\w+)|(?<!\w+)u(?!\w+))/gi, 'your sister')
